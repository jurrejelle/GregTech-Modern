...
public class AdaptableUITexture extends UITexture {
    ...
    public void drawStretched(float x, float y, float width, float height) {
        ...
        if ((this.bl > 0 || this.br > 0) && this.bt <= 0 && this.bb <= 0) {
            ...
            // left border
            GuiDraw.drawTexture(x, y + this.bt, x + this.bl, y1 - this.bb, this.u0, vInnerStart, uInnerStart,
                    vInnerEnd);
            // top border
            GuiDraw.drawTexture(x + this.bl, y, x1 - this.br, y + this.bt, uInnerStart, this.v0, uInnerEnd,
                    vInnerStart);
            // right border
            GuiDraw.drawTexture(x1 - this.br, y + this.bt, x1, y1 - this.bb, uInnerEnd, vInnerStart, this.u1,
                    vInnerEnd);
            // bottom border
            GuiDraw.drawTexture(x + this.bl, y1 - this.bb, x1 - this.br, y1, uInnerStart, vInnerEnd, uInnerEnd,
                    this.v1);

            // center
            GuiDraw.drawTexture(x + this.bl, y + this.bt, x1 - this.br, y1 - this.bb, uInnerStart, vInnerStart,
                    uInnerEnd, vInnerEnd);
        }
    ...
    public void drawTiled(float x, float y, float width, float height) {
        ...
        if ((this.bl > 0 || this.br > 0) && this.bt <= 0 && this.bb <= 0) {
            ...
            // right border
            GuiDraw.drawTiledTexture(x1 - this.br, y, this.br, height, uInnerEnd, this.v0, this.u1, this.v1, this.br,
                    th, 0);
            // center
            GuiDraw.drawTiledTexture(x + this.bl, y, width - this.bl - this.br, height, uInnerStart, this.v0, uInnerEnd,
            ...
            // bottom border
            GuiDraw.drawTiledTexture(x, y1 - this.bb, width, this.bb, this.u0, vInnerEnd, this.u1, this.v1, tw, this.bb,
                    0);
            // center
            GuiDraw.drawTiledTexture(x, y + this.bt, width, height - this.bt - this.bb, this.u0, vInnerStart, this.u1,
                    vInnerEnd, tw, th - this.bt - this.bb, 0);
        } else {
            // top left corner
            GuiDraw.drawTiledTexture(x, y, this.bl, this.bt, this.u0, this.v0, uInnerStart, vInnerStart, this.bl,
                    this.bt, 0);
            // top right corner
            GuiDraw.drawTiledTexture(x1 - this.br, y, this.br, this.bt, uInnerEnd, this.v0, this.u1, vInnerStart,
                    this.br, this.bt, 0);
            // bottom left corner
            GuiDraw.drawTiledTexture(x, y1 - this.bb, this.bl, this.bb, this.u0, vInnerEnd, uInnerStart, this.v1,
                    this.bl, this.bb, 0);
            // bottom right corner
            GuiDraw.drawTiledTexture(x1 - this.br, y1 - this.bb, this.br, this.bb, uInnerEnd, vInnerEnd, this.u1,
                    this.v1, this.br, this.bb, 0);

            // left border
            GuiDraw.drawTiledTexture(x, y + this.bt, this.bl, height - this.bt - this.bb, this.u0, vInnerStart,
                    uInnerStart, vInnerEnd, this.bl, th - this.bt - this.bb, 0);
            // top border
            GuiDraw.drawTiledTexture(x + this.bl, y, width - this.bl - this.br, this.bt, uInnerStart, this.v0,
                    uInnerEnd, vInnerStart, tw - this.bl - this.bb, this.bt, 0);
            // right border
            GuiDraw.drawTiledTexture(x1 - this.br, y + this.bt, this.br, height - this.bt - this.bb, uInnerEnd,
                    vInnerStart, this.u1, vInnerEnd, this.br, th - this.bt - this.bb, 0);
            // bottom border
            GuiDraw.drawTiledTexture(x + this.bl, y1 - this.bb, width - this.bl - this.br, this.bb, uInnerStart,
                    vInnerEnd, uInnerEnd, this.v1, tw - this.bl - this.br, this.bb, 0);

            // center
            GuiDraw.drawTiledTexture(x + this.bl, y + this.bt, width - this.bl - this.br, height - this.bt - this.bb,
