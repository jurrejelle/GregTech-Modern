...
public class MultiblockInfoJeiCategory extends
    ...
    @Override
    public void createRecipeExtras(IRecipeExtrasBuilder builder, MultiblockInfoWrapper recipe,
                                   IFocusGroup focuses) {
    ...
    @Override
    public @Nullable ResourceLocation getRegistryName(MultiblockInfoWrapper recipe) {
