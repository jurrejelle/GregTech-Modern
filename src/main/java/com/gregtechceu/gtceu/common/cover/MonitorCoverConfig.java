...
public record MonitorCoverConfig(
    ...
    public static final Codec<MonitorCoverConfig> CODEC = RecordCodecBuilder.create(i ->
            i.group(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, MonitorCoverConfig> STREAM_CODEC =
